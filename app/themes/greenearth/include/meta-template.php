		...
		?>
			...
			<div class="meta-body">
				...
				<div class="meta-input">
					<input type="text" name="<?php echo $name; ?>" id="<?php echo str_replace('[]', '', $name); ?>" value="<?php 
							...
							<ul>
								<li id="default" class="default">
									...
									<div id="slider-detail" class="slider-detail"> 	
										...
										<div class="meta-detail-input meta-input"><textarea type="text" id='<?php echo $name['title']; ?>' ></textarea></div><br class="clear">
										<hr class="separator">
									...
									if(!empty($value)){
										...
										foreach ($value->childNodes as $slider){ ?> 
											...
											<li class="slider-image-init">
												...
												<div id="slider-detail" class="slider-detail">								
													<div class="meta-title meta-detail-title"><?php _e('SLIDER TITLE', 'gdl_back_office'); ?></div> 
													<div class="meta-detail-input meta-input"><textarea type="text" name='<?php echo $name['title']; ?>[]' id='<?php echo $name['title']; ?>[]' ><?php echo find_xml_value($slider, 'title'); ?></textarea></div><br class="clear">
													<hr class="separator">
													<div class="meta-title meta-detail-title"><?php _e('SLIDER CAPTION', 'gdl_back_office'); ?></div>
